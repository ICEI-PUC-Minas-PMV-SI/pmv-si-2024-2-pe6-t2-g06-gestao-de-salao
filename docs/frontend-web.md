...
Armazena o histórico de pagamentos realizados para auditoria e consultas ou edições futuras.
Atributos: Id, salaoId, tipo, valor, dataPagamento, modoPagamento.
Relações: Está associado a um pagamento específico.
