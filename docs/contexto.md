...
| RNF-03    | *Desempenho*     | *Capacidade de Processamento*: A aplicação deve ser capaz de processar múltiplas requisições simultâneas, especialmente durante horários de pico, sem afetar a performance.       | Alta         |
...
| RNF-05    | *Usabilidade*    | *Compatibilidade com Dispositivos Móveis*: A aplicação deve ser responsiva e garantir uma excelente experiência em dispositivos móveis, incluindo smartphones e tablets que utilizem Android e iOS. | Alta         |
